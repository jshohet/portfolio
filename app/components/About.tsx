  ...
  return (
    <div className="mb-20 mt-10" id={id}>
      ...
      <div className="flex flex-col lg:flex-row mt-10 justify-center">
        <div className="bg-slate-700 text-white rounded-lg lg:mr-10 w-fit lg:max-w-[30%] p-2 lg:ml-0 mx-2">
        ...
        <section className="w-fit lg:max-w-[40%] flex flex-col lg:mx-0 mx-1">
