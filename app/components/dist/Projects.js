    ...
    return (react_1["default"].createElement("div", { id: id },
        ...
        react_1["default"].createElement("div", { className: "ml-52" },
            react_1["default"].createElement("div", { className: "flex flex-row mb-10" },
                react_1["default"].createElement(image_1["default"], { src: "/img/chewplushdemo.PNG", width: 300, height: 300, alt: "Chew plush store demo image.", className: "hover:transition-all hover:scale-125 hover:ease-in-out hover:duration-500 mr-10 rounded-md" }),
            ...
            react_1["default"].createElement("div", { className: "flex flex-row mb-10" },
                react_1["default"].createElement(image_1["default"], { src: "/img/currencyexchangedemo.PNG", width: 300, height: 300, alt: "Currency exchange demo.", className: "hover:transition-all hover:scale-125 hover:ease-in-out hover:duration-500 mr-10 rounded-md" }),
                react_1["default"].createElement("div", { className: "max-w-[50%]" },
                    react_1["default"].createElement("h2", { className: "font-bold text-xl mb-2" }, "Exchange Global"),
                    react_1["default"].createElement("p", { className: "mb-2" }, "Exchange Global is a sleek, fast way to look up rates for almost any currency, including crypto."),
                    react_1["default"].createElement("div", { className: "flex flex-row mb-2" },
                        react_1["default"].createElement(bi_1.BiLogoTypescript, { size: 30, className: "text-cyan-400" }),
                        react_1["default"].createElement(bi_1.BiLogoTailwindCss, { size: 30, className: "text-cyan-600" }),
                        react_1["default"].createElement(tb_1.TbBrandNextjs, { size: 30, className: "text-black" })),
            ...
            react_1["default"].createElement("div", { className: "flex flex-row" },
                react_1["default"].createElement(image_1["default"], { src: "/img/todolistdemo.PNG", width: 300, height: 300, alt: "To-do list demo.", className: "hover:transition-all hover:scale-125 hover:ease-in-out hover:duration-500 mr-10 rounded-md" }),
                react_1["default"].createElement("div", { className: "max-w-[50%]" },
